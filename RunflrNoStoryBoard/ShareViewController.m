...
@property (strong, nonatomic) NSString *kPlaceholderPostMessage;
...
@synthesize kPlaceholderPostMessage;
@synthesize rest;
...
- (void)viewDidLoad
{
    ...
    if (self.imagePath) {
        ...
        image = @"http://cms.citychef.pt/data/logo_rundlr_facebook.png";
    }
    
    if (self.restName) {
        //kPlaceholderPostMessage = [NSString stringWithFormat: self.restName, self.restAddress];
        
        kPlaceholderPostMessage = @"";
    } else {
       // kPlaceholderPostMessage = [Language textForIndex:@"FaceDefault"];
         kPlaceholderPostMessage = @"";
    }
